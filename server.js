...
(function() {
  ...
  try {
    ...
    style.textContent = [
      ...
      '}',
      '.site-logo-img, .site-branding, .custom-logo-link {',
      ...
      '  .site-logo-img .transparent-custom-logo { display: inline-flex !important; }',
      '  .site-logo-img .ast-transparent-mobile-logo { display: none !important; }',
      '}',
      '@media (max-width: 921px) {',
      '  .site-logo-img .transparent-custom-logo { display: none !important; }',
      '  .site-logo-img .ast-transparent-mobile-logo { display: inline-flex !important; visibility: visible !important; opacity: 1 !important; }',
      '}',
      '.ast-header-break-point .site-logo-img .transparent-custom-logo { display: none !important; }',
      '.ast-header-break-point .site-logo-img .ast-transparent-mobile-logo { display: inline-flex !important; visibility: visible !important; opacity: 1 !important; }',
      '.site-logo-img img, .custom-logo, .custom-logo-link img, .transparent-custom-logo img, .ast-transparent-mobile-logo img {',
