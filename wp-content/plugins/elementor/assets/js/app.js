  ...
  return {
    backToDashboard: function backToDashboard() {
      if (window.top === window) {
        window.location = elementorAppConfig.admin_url;
      } else {
        // Iframe.
    ...
    backToReferrer: function backToReferrer() {
      if (window.top === window) {
        ...
        window.location = elementorAppConfig.return_url.includes(elementorAppConfig.login_url) ? elementorAppConfig.admin_url : elementorAppConfig.return_url;
      } else {
        // Iframe.
        window.top.$e.run('app/close');
      }
